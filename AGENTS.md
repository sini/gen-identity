...
| Dedup and trace keys                                                                         | their own libraries — `gen-edge` `hashTrace`, `gen-memo` `hashOf`, `gen-resolve` `classkey`. Whether those are identities or digests is not settled here                                                                                                   |
